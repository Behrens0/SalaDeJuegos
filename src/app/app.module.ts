...
@NgModule({
  ...
  { path: 'about', loadChildren: () => import('./pages/quienSoy/about.module').then(m => m.AboutModule) },
  { path: 'ahorcado', loadChildren: () => import('./pages/ahorcado/ahorcado.module').then(m => m.AhorcadoModule) },
  { path: 'mayor-menor', loadChildren: () => import('./pages/mayor-o-menor/mayor-o-menor.module').then(m => m.MayorOMenorModule) },
  { path: 'preguntados', loadChildren: () => import('./pages/preguntados/preguntados.module').then(m => m.PreguntadosModule) },
  { path: 'gameOfThrones', loadChildren: () => import('./pages/game-of-thrones/game-of-thrones.module').then(m => m.GameOfThronesModule) },
